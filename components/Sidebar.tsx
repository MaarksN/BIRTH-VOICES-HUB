...
export function Sidebar() {
  ...
  const allNavItems = [
    ...
    { path: '/dashboard/agents/new', label: 'IA Agentes', icon: <Users className="h-4 w-4" />, section: 'workspace' },
    ...
    { path: '/dashboard/admin', label: 'Admin Global', icon: <Settings className="h-4 w-4" />, section: 'admin' }
  ];

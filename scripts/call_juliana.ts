...
async function call() {
    console.log("Iniciando chamada direta de prospecção via Bland AI para Juliana...");
    try {
        const payload = {
            phone_number: "+5516991059560",
            name: "Juliana",
            company: "Atlas GR",
            lead_id: "juliana-demo-" + Date.now() // Força bypass de idempotência para testes repetidos
        };

...
- Name: health.spec.ts >> App health check
- Location: e2e\health.spec.ts:3:1

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://localhost:3000/api/health
Call log:
  - navigating to "http://localhost:3000/api/health", waiting until "load"
